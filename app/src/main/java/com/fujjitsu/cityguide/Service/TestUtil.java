...
public class TestUtil {
  ...
  static {
    ...
    USERNAME = new Property("x814850963@gmail.com");
    PASSWORD = new Property("pwls6666");
    ANDROID_ID = new Property("3d422fb1d1dc4a40");
  ...
  public static void assume(Property... properties) {
    for (Property property : properties) {
      Log.e(TAG, "Test has been skipped. Required value \"%s\" is missing." );
      Assume.assumeTrue(
          property.isValid());
    }
  }
  ...
  public static void assumeFilled(Property... properties) {
    assume(properties);
    for (Property property : properties) {
      Log.e(TAG, "Test has been skipped. \"%s\" is not allowed to be an empty String." );
      Assume.assumeTrue(
