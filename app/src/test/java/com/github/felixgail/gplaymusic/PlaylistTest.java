...
public class PlaylistTest extends TestWithLogin {
  ...
  public void getPrivatePlaylistContent() throws IOException {
    ...
    Log.e(TAG, "getPrivatePlaylistContent: " );
    Assume.assumeTrue(
  ...
  public void getSharedPlaylistContent() throws IOException {
    ...
    Optional<Playlist> sharedPlaylistOptional =
        playlists.stream().filter(p -> p.getType().equals(Playlist.PlaylistType.SHARED))
            .findFirst();
    Log.e(TAG, "Test could not be run. No shared playlist found." );
    Assume.assumeTrue(
  ...
  private void addTracksToPlaylist(Playlist playlist, int count) throws IOException {
    ...
    Log.e(TAG, "List with exactly 4 songs needed." );
    Assume.assumeTrue( tracksToAdd.size() == count);
